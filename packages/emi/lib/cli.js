...
var package_default = {
  ...
  bin: "./bin/emi.js",
  scripts: {
    build: "npx esbuild ./src/** --platform=node --bundle --outdir=lib",
...
// src/cli.ts
program.name("emi").description("CLI to emi").version(package_default.version, "-v,--version");
program.command("dev").argument("<string>", "dev it-;").option("-l,--log <char>", "log it").action((argument, options) => {
